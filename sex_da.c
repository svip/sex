...
static char     *faster[] = {
  ...
  "\"Sesam, luk dig op!\"",                     "\"Sikke noget røvknaldebusiness!\"",
  "\"Igen!\"",                           "\"Hurtigere!\"",
  "\"Hårdere!\"",                          "\"Hjælp!\"",
...
static char     *male[] = {
  ...
  "røvknalder" ,          "Fisserasmus",          "ulækre gamle mand",
  "homofile tigger",      "fissefarfar",          "advokat",
  "hårrodsfetishist",     "præst",                "bolleknægt",
  "homoflamingo",         "eks-cølibate",         "stofsniffer",
  "kjolemand",            "konstruktionsarbejder","kusseknepminister",
  "tandlæge",             "dommer",               "socialmedarbejder",
  "viking",               "knaldebror",           "tv-reparatør",
  "pizzaudbringer",       "pave",                 "Fader",
  "læge",                 "gynækolog",            "Batman",
...
static char     *dong[] = {
  ...
  "vejviser",             "slambert",             "kussekneppebusiness",
...
static char     *twatadj[] = {
  ...
  "taknemmelige",         "mugne",                "tandbesatte",
...
static char     *twat[] = {
  ...
  "babyfabrik.",          "trutkneppesprække.",   "røv.",
  "rosenskud.",           "svælg.",               "øjenåbning.",
  "svedkanal.",           "indre øre.",           "kropsåbning.",
  "operationsar.",        "åbne sår.",            "navle.",
  "mund.",                "næse.",                "fisse.",
  "/dev/null.",           "øksehug.",             "mellemgulvsmund.",
  "bollegrotte.",         "begivenhedshorisont.", "fællesnævner.",
  "skinke.",              "bagdør.",              "svingdør.",
  "vandrehal.",           "hundredårskrigsstarter.",   "VGA-indgang.",
  "nødudgang.",
};
